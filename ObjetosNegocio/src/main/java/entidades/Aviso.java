...
public class Aviso {
     ...
     */
    public Aviso(ObjectId id, String titulo, Date fechaHora, String mensaje, ObjectId idMaestro, Map<ObjectId, String> listaRespuestas) {
        this.id = id;
        this.titulo = titulo;
     ...
     * @param idMaestro
     */
    public Aviso(ObjectId id, String titulo, Date fechaHora, String mensaje, ObjectId idMaestro) {
        this.id = id;
        this.titulo = titulo;
        this.fechaHora = fechaHora;
        this.mensaje = mensaje;
     ...
     * @param idMaestro
     */
    public Aviso(ObjectId id, String titulo, Date fechaHora, ObjectId idMaestro) {
        this.id = id;
        this.titulo = titulo;
        this.fechaHora = fechaHora;
        this.idMaestro = idMaestro;
     ...
     * @param mensaje
     */
    public Aviso(String titulo, Date fechaHora, String mensaje) {
        this.titulo = titulo;
        this.fechaHora = fechaHora;
        this.mensaje = mensaje;
    }
     ...
     * @param listaRespuestas
     */
    public Aviso(String titulo, Date fechaHora, String mensaje, ObjectId idMaestro, Map<ObjectId, String> listaRespuestas) {
        this.titulo = titulo;
        this.fechaHora = fechaHora;
        this.mensaje = mensaje;
        this.idMaestro = idMaestro;
