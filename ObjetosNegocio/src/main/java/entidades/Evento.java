...
/**
 * Representa un evento con información básica como título, descripción, fecha, hora de inicio, 
 * hora de finalización, campus y categoría. Esta clase permite almacenar y gestionar los datos 
...
public class Evento {
     ...
     */
    public Evento(String titulo, String descripcion, Date fechaInicio, Date fechaFinal, 
