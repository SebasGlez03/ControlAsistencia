 ...
 * usuario. Esta clase se utiliza para transportar datos del usuario entre
...
public class UsuarioDTO {
    ...
    private ObjectId rol; //Rol del usuario
     ...
     */
    public UsuarioDTO(int matricula, String nombre, String apellidoPaterno, String apellidoMaterno, String correo, String contrasenia, ObjectId rol) {
     ...
     * @param rol Rol del usuario
     */
    public UsuarioDTO(String nombre, String apellidoPaterno, String apellidoMaterno, String correo, String contrasenia, ObjectId rol) {
        this.nombre = nombre;
        this.apellidoPaterno = apellidoPaterno;
        this.apellidoMaterno = apellidoMaterno;
        this.correo = correo;
     ...
     *
     * @return Rol del usuario obtenido
     */
     ...
     *
     * @param rol Rol del usuario a establecer
     */
