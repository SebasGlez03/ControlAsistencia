 ...
 * @author PC
 */
public class FrmModificarAlumnos extends javax.swing.JFrame {
    ...
    public FrmModificarAlumnos(UsuarioDTO usuarioRecibido) {
        initComponents();
        llenarComboBox(comboBoxRol);
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        try {
            ...
            FrmGestionarAlumnos frmGestionarUsuarios = new FrmGestionarAlumnos();
    ...
    private void btnCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarActionPerformed
        FrmGestionarAlumnos gestionarUsuarios = new FrmGestionarAlumnos();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmModificarAlumnos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmModificarAlumnos().setVisible(true);
            }
        });
    }
